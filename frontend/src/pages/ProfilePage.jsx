...
import { Camera, User, Mail } from "react-feather";
  ...
  return (
    <div className="pt-20">
      ...
      <div className="max-w-2xl mx-auto p-4 py-8 ">
        <div className="bg-b-300 rounded-xl p-6 space-y-4">
          ...
          <div className="flex flex-col items-center gap-4 border border-pink-300 rounded-lg p-4">
